...
# create command line for File Watcher
...
Write-Host "Ima $($InputPaths.Length) ulazih direktorija"
...
pause
#param([string]$mUCPath = "C:\OpenMUCLinux\Test_StagingData",[string]$summaryFilesPath = "C:\OpenMUCLinux\Test_Summary",[double] $ServiceMultiplier = 1/30)
$commandControl = "$PSScriptRoot\OpenMUC_DataControll.ps1 -mUCPath '$StagingDataPath' -summaryFilesPath '$SummaryDataPath'  -ServiceMultiplier  (1/30)"
$commandControl
